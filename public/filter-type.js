        ...
        container.innerHTML = `
            <div class="no-jobs-card">
                <div class="no-jobs-content">
                    <img src="/JOB2-main/img/unemployment.png" alt="No Jobs" class="unemployment-img">
            ...
            <div class="job-card" style="cursor: pointer;">
                ...
                <div class="job-info">
                    ...
                    <div class="salary-expiry-inline">
                        <div class="salary" onclick="openJobDetails('${job._id}')"><img src="/JOB2-main/img/save-money.png" alt="Salary" class="field-icon"> <strong>Salary:</strong> ${salary}</div>
                        <div class="expiry-date" onclick="openJobDetails('${job._id}')"><img src="/JOB2-main/img/calendar.png" alt="Expiry" class="field-icon"> <strong>Expires:</strong> ${job.expiryDate || 'Not specified'}</div>
                    </div>
                    ${job.urgent ? '<span class="badge urgent" title="Urgent"><img src="/JOB2-main/img/urgent.png" alt="Urgent" class="star-icon"></span>' : ''}
                    ${job.featured ? '<span class="badge featured" title="Featured"><img src="/JOB2-main/img/features.png" alt="Featured" class="star-icon"></span>' : ''}
                </div>
            </div>
        `;
    }).join('');
